...
(() => {
  ...
  var B512Coder = class extends Coder {
    ...
    decode(data, offset) {
      let bytes2 = data.slice(offset, offset + 64);
      const decoded = bn(bytes2);
      if (decoded.isZero()) {
      ...
      return [toHex(bytes2, 64), offset + 64];
    }
  };
  ...
  var BooleanCoder = class extends Coder {
    ...
    decode(data, offset) {
      const bytes2 = bn(data.slice(offset, offset + 8));
      if (bytes2.isZero()) {
  ...
  var NumberCoder = class extends Coder {
    ...
    decode(data, offset) {
      ...
      return [toNumber2(bytes2), offset + 8];
    }
  };
