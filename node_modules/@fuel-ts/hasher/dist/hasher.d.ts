 ...
 */
export declare function hashMessage(msg: string): string;
/**
 ...
 */
export declare function hashTransaction(transactionRequestLike: TransactionRequestLike, chainId: number): string;
/**
 * wrap sha256
 *
