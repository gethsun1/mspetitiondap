...
function hashMessage(msg) {
  return (0, import_ethers.sha256)((0, import_crypto.bufferFromString)(msg, "utf-8"));
}
...
function hashTransaction(transactionRequestLike, chainId) {
  ...
  const concatenatedData = (0, import_ethers.concat)([chainIdBytes, new import_transactions.TransactionCoder().encode(transaction)]);
