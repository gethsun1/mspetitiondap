...
var getPredicateRoot = (bytecode, chainId) => {
  ...
  const predicateRoot = (0, import_hasher.hash)((0, import_ethers.concat)(["0x4655454C", chainIdBytes, codeRoot]));
...
var Predicate = class extends import_wallet.Account {
  ...
  constructor(bytes, provider, jsonAbi, configurableConstants) {
    ...
    const address = import_address.Address.fromB256(getPredicateRoot(predicateBytes, chainId));
   ...
   */
  async getTransferTxId(destination, amount, assetId = import_configs.BaseAssetId, txParams = {}) {
    ...
    return (0, import_hasher2.hashTransaction)(populatedRequest, this.provider.getChainId());
  }
  /**
  ...
  setData(...args) {
    ...
    const OFFSET = VM_TX_MEMORY + import_abi_coder.SCRIPT_FIXED_SIZE + import_abi_coder.INPUT_COIN_FIXED_SIZE + import_abi_coder.WORD_SIZE + paddedCode.byteLength;
