// src/coders/input.ts
import { Coder as Coder2, U64Coder, B256Coder as B256Coder2, NumberCoder as NumberCoder3 } from "@fuel-ts/abi-coder";
...
import { B256Coder, NumberCoder as NumberCoder2, StructCoder as StructCoder2 } from "@fuel-ts/abi-coder";
var UtxoIdCoder = class extends StructCoder2 {
  constructor() {
    super("UtxoId", {
      transactionId: new B256Coder(),
      outputIndex: new NumberCoder2("u8")
    });
  }
};
...
var InputCoinCoder = class extends Coder2 {
  ...
  encode(value) {
    ...
    parts.push(new B256Coder2().encode(value.owner));
    parts.push(new U64Coder().encode(value.amount));
    parts.push(new B256Coder2().encode(value.assetId));
    parts.push(new TxPointerCoder().encode(value.txPointer));
    parts.push(new NumberCoder3("u8").encode(value.witnessIndex));
    parts.push(new NumberCoder3("u32").encode(value.maturity));
    parts.push(new U64Coder().encode(value.predicateGasUsed));
    parts.push(new NumberCoder3("u32").encode(value.predicateLength));
    parts.push(new NumberCoder3("u32").encode(value.predicateDataLength));
  ...
  decode(data, offset) {
    ...
    [decoded, o] = new NumberCoder3("u32").decode(data, o);
...
var InputMessageCoder = class extends Coder2 {
  ...
  encode(value) {
    ...
    parts.push(new NumberCoder3("u8").encode(value.witnessIndex));
    parts.push(new U64Coder().encode(value.predicateGasUsed));
    parts.push(new NumberCoder3("u16").encode(data.length));
    parts.push(new NumberCoder3("u16").encode(value.predicateLength));
    parts.push(new NumberCoder3("u16").encode(value.predicateDataLength));
  ...
  decode(data, offset) {
    ...
    [decoded, o] = new U64Coder().decode(data, o);
    const predicateGasUsed = decoded;
    [decoded, o] = new NumberCoder3("u16").decode(data, o);
    const predicateLength = decoded;
    [decoded, o] = new NumberCoder3("u16").decode(data, o);
...
import { Coder as Coder3, U64Coder as U64Coder2, B256Coder as B256Coder3, NumberCoder as NumberCoder4 } from "@fuel-ts/abi-coder";
...
var OutputContractCoder = class extends Coder3 {
  ...
  encode(value) {
    const parts = [];
    parts.push(new NumberCoder4("u8").encode(value.inputIndex));
    parts.push(new B256Coder3().encode(value.balanceRoot));
    parts.push(new B256Coder3().encode(value.stateRoot));
    return concat3(parts);
  }
  decode(data, offset) {
    let decoded;
    let o = offset;
    [decoded, o] = new NumberCoder4("u8").decode(data, o);
...
var OutputCoder = class extends Coder3 {
  ...
  encode(value) {
    const parts = [];
    parts.push(new NumberCoder4("u8").encode(value.type));
    const { type } = value;
    switch (type) {
      case 0 /* Coin */: {
...
import { Coder as Coder4, U64Coder as U64Coder3, B256Coder as B256Coder4, NumberCoder as NumberCoder5 } from "@fuel-ts/abi-coder";
...
var ReceiptCallCoder = class extends Coder4 {
  constructor() {
    super("ReceiptCall", "struct ReceiptCall", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new B256Coder4().encode(value.from));
    parts.push(new B256Coder4().encode(value.to));
    parts.push(new U64Coder3().encode(value.amount));
    parts.push(new B256Coder4().encode(value.assetId));
    parts.push(new U64Coder3().encode(value.gas));
    parts.push(new U64Coder3().encode(value.param1));
    parts.push(new U64Coder3().encode(value.param2));
    parts.push(new U64Coder3().encode(value.pc));
    parts.push(new U64Coder3().encode(value.is));
  ...
  decode(data, offset) {
    ...
    [decoded, o] = new B256Coder4().decode(data, o);
    const to = decoded;
    [decoded, o] = new U64Coder3().decode(data, o);
    const amount = decoded;
    [decoded, o] = new B256Coder4().decode(data, o);
    const assetId = decoded;
    [decoded, o] = new U64Coder3().decode(data, o);
...
var ReceiptReturnCoder = class extends Coder4 {
  constructor() {
    super("ReceiptReturn", "struct ReceiptReturn", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new B256Coder4().encode(value.id));
    parts.push(new U64Coder3().encode(value.val));
    parts.push(new U64Coder3().encode(value.pc));
    parts.push(new U64Coder3().encode(value.is));
    return concat4(parts);
  }
...
var ReceiptReturnDataCoder = class extends Coder4 {
  constructor() {
  ...
  encode(value) {
    const parts = [];
    parts.push(new B256Coder4().encode(value.id));
    parts.push(new U64Coder3().encode(value.ptr));
    parts.push(new U64Coder3().encode(value.len));
    parts.push(new B256Coder4().encode(value.digest));
    parts.push(new U64Coder3().encode(value.pc));
    parts.push(new U64Coder3().encode(value.is));
    return concat4(parts);
  }
...
var ReceiptPanicCoder = class extends Coder4 {
  constructor() {
  ...
  encode(value) {
    const parts = [];
    parts.push(new B256Coder4().encode(value.id));
    parts.push(new U64Coder3().encode(value.reason));
    parts.push(new U64Coder3().encode(value.pc));
    parts.push(new U64Coder3().encode(value.is));
    parts.push(new B256Coder4().encode(value.contractId));
    return concat4(parts);
  }
  decode(data, offset) {
    let decoded;
...
var ReceiptRevertCoder = class extends Coder4 {
  constructor() {
...
var ReceiptLogCoder = class extends Coder4 {
  constructor() {
  ...
  encode(value) {
    const parts = [];
    parts.push(new B256Coder4().encode(value.id));
    parts.push(new U64Coder3().encode(value.val0));
    parts.push(new U64Coder3().encode(value.val1));
    parts.push(new U64Coder3().encode(value.val2));
    parts.push(new U64Coder3().encode(value.val3));
    parts.push(new U64Coder3().encode(value.pc));
    parts.push(new U64Coder3().encode(value.is));
    return concat4(parts);
  }
...
var ReceiptLogDataCoder = class extends Coder4 {
  constructor() {
...
var ReceiptTransferCoder = class extends Coder4 {
  constructor() {
...
var ReceiptTransferOutCoder = class extends Coder4 {
  constructor() {
...
var ReceiptScriptResultCoder = class extends Coder4 {
  constructor() {
    super("ReceiptScriptResult", "struct ReceiptScriptResult", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new U64Coder3().encode(value.result));
    parts.push(new U64Coder3().encode(value.gasUsed));
    return concat4(parts);
  }
  decode(data, offset) {
    let decoded;
...
var ReceiptMessageOutCoder = class extends Coder4 {
  constructor() {
  ...
  static getMessageId(value) {
    ...
    return sha2562(concat4(parts));
  }
  encode(value) {
    const parts = [];
    parts.push(new B256Coder4().encode(value.sender));
    parts.push(new B256Coder4().encode(value.recipient));
    parts.push(new U64Coder3().encode(value.amount));
    parts.push(new B256Coder4().encode(value.nonce));
...
var getAssetIdForMintAndBurnReceipts = (contractId, subId) => {
  ...
  return sha2562(concat4([contractIdBytes, subIdBytes]));
};
var ReceiptMintCoder = class extends Coder4 {
  constructor() {
  ...
  encode(value) {
    const parts = [];
    parts.push(new B256Coder4().encode(value.subId));
    parts.push(new B256Coder4().encode(value.contractId));
    parts.push(new U64Coder3().encode(value.val));
    parts.push(new U64Coder3().encode(value.pc));
    parts.push(new U64Coder3().encode(value.is));
...
var ReceiptBurnCoder = class extends Coder4 {
  constructor() {
...
var ReceiptCoder = class extends Coder4 {
  constructor() {
  ...
  encode(value) {
    ...
    switch (value.type) {
      ...
      default: {
        throw new FuelError3(ErrorCode3.INVALID_RECEIPT_TYPE, `Invalid receipt type: ${type}`);
      }
    }
    return concat4(parts);
  }
...
import { B256Coder as B256Coder5, StructCoder as StructCoder3 } from "@fuel-ts/abi-coder";
var StorageSlotCoder = class extends StructCoder3 {
  constructor() {
    super("StorageSlot", {
      key: new B256Coder5(),
      value: new B256Coder5()
    });
  }
};

// src/coders/transaction.ts
import { Coder as Coder6, ArrayCoder, U64Coder as U64Coder4, B256Coder as B256Coder6, NumberCoder as NumberCoder7 } from "@fuel-ts/abi-coder";
...
import { Coder as Coder5, NumberCoder as NumberCoder6 } from "@fuel-ts/abi-coder";
import { concat as concat5 } from "@fuel-ts/utils";
var WitnessCoder = class extends Coder5 {
  constructor() {
    super(
      "Witness",
...
var TransactionScriptCoder = class extends Coder6 {
  constructor() {
    super("TransactionScript", "struct TransactionScript", 0);
  }
  encode(value) {
    const parts = [];
    parts.push(new U64Coder4().encode(value.gasPrice));
    parts.push(new U64Coder4().encode(value.gasLimit));
    parts.push(new NumberCoder7("u32").encode(value.maturity));
...
var TransactionCreateCoder = class extends Coder6 {
  constructor() {
...
var TransactionMintCoder = class extends Coder6 {
  constructor() {
...
var TransactionCoder = class extends Coder6 {
  constructor() {
    ...
    switch (value.type) {
      ...
      default: {
        throw new FuelError4(
          ErrorCode4.INVALID_TRANSACTION_TYPE,
