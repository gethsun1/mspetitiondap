...
var getProjectStorageSlotsPath = (params) => (0, import_path.join)(getProjectDebugDir(params), `${params.projectName}-storage_slots.json`);
...
var getForcProject = (params) => {
  ...
  const binHexlified = (0, import_ethers.hexlify)((0, import_fs.readFileSync)(binPath));
