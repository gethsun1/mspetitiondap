...
import type { TransactionRequestLike, CallResult, TransactionRequest, Coin, CoinQuantityLike, CoinQuantity, Message, Resource, ExcludeResourcesOption, TransactionResponse, Provider } from '@fuel-ts/providers';
...
export declare class Account extends AbstractAccount {
     ...
     */
    fund<T extends TransactionRequest>(request: T, quantities: CoinQuantity[], fee: BN): Promise<void>;
    /**
     ...
     */
    protected prepareTransferTxRequest(
    /** Address of the destination */
    destination: AbstractAddress, 
    /** Amount of coins */
    amount: BigNumberish, 
