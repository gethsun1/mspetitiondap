import type { TransactionResponse, TransactionRequestLike, CallResult, Provider } from '@fuel-ts/providers';
...
export declare class BaseWalletUnlocked extends Account {
     ...
     */
    populateTransactionWitnessesSignature(transactionRequestLike: TransactionRequestLike): Promise<import("@fuel-ts/providers").TransactionRequest>;
    /**
...
//# sourceMappingURL=base-unlocked-wallet.d.ts.map