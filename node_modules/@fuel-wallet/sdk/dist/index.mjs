...
import { JSONRPCClient, JSONRPCServer, createJSONRPCSuccessResponse } from 'json-rpc-2.0';
import { v4 } from 'uuid';
...
var FuelWalletProvider = class _FuelWalletProvider extends Provider {
...
export { AddressType, BACKGROUND_SCRIPT_NAME, BLOCK_EXPLORER_URL, BaseConnection, CONTENT_SCRIPT_NAME, ContentProxyConnection, EVENT_MESSAGE, ExtensionPageConnection, Fuel, FuelWalletConnection, FuelWalletEvents, FuelWalletLocked, FuelWalletProvider, MessageTypes, POPUP_SCRIPT_NAME, VAULT_SCRIPT_NAME, WindowConnection, createConnector, createReadOnly, createUUID, deferPromise, getBlockExplorerLink, getGasConfig, getTransactionSigner, hasWindow };
